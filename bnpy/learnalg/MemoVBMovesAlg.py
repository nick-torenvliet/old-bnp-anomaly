...
class MemoVBMovesAlg(LearnAlg):
    ...
    def fit(self, hmodel, DataIterator, **kwargs):
        ...
        while DataIterator.has_next_batch():
            ...
            SS = self.incrementWholeDataSummary(SS, SSbatch, oldSSbatch, lapFrac=lapFrac, hmodel=hmodel)
            ...
            if self.doDebug() and lapFrac >= 1.0:
                self.verifyELBOTracking(hmodel, SS, loss, MoveLog=MoveLog, lapFrac=lapFrac)
            ...
            if self.isSaveParamsCheckpoint(lapFrac, iterid):
                self.saveParams(lapFrac, hmodel, SS, didExactUpdateWithSS=didUpdate)
